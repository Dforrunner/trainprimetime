...
const Schedule = () => {
    return <>
        ...
        <section className='w-full min-h-[600px] bg-white text-black flex flex-col items-center p-20'>
            <h1 className='text-3xl pb-10'>Schedule</h1>

            <div className="flex overflow-hidden w-[900px] border-[1px] rounded border-[rgba(0,0,0,0.3)] p-5">
                    ...
                    <div className="flex flex-col flex-grow">
                        <div className="flex items-center mt-4">
                            ...
                            <h2 className="ml-2 text-xl font-bold leading-none">October, 2022</h2>
                        </div>
                        ...
                        <div
                            className="grid flex-grow w-full h-auto grid-cols-7 grid-rows-5 gap-px pt-px mt-1 bg-gray-200">
                            <div/>
                            <div className="relative flex flex-col bg-white group">
                                ...
                                <div className="flex flex-col px-1 py-1 overflow-auto">
                                    <button
                                        ...
                                        <span
                                            className="flex-shrink-0 w-2 h-2 border border-gray-500 rounded-full"/>
                                        <span className="ml-2 font-light leading-none">8:30am</span>
                                        <span
                                            className="ml-2 font-medium leading-none truncate">An unconfirmed event</span>
                                    </button>
                                    <button
                                        className="flex items-center flex-shrink-0 h-5 px-1 text-xs hover:bg-gray-200">
                                        <span className="flex-shrink-0 w-2 h-2 bg-gray-500 rounded-full"/>
                                        <span className="ml-2 font-light leading-none">2:15pm</span>
                                        <span
                                            className="ml-2 font-medium leading-none truncate">A confirmed event</span>
                                    </button>
                                </div>
                                <button
