...
const ListItem = ({href, title}) =>
   <li
      className='w-full md:w-auto inline-block transition-all ease-in-out duration-500 hover:text-secondary'>
      <Link href={href}>
            <span className='py-3 px-3 cursor-pointer text-center '>
            {title}
         </span>
      </Link>
   </li>
