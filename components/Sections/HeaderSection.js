...
const HeaderSection = ({title, summary, btnTitle, btnHref, bgImg = '/dumbells.png'}) =>
   <header className='w-full h-[500px] relative'>
      ...
      <div className='w-full h-full'>
         <Image src={bgImg} alt='' layout='fill' objectFit='cover' objectPosition='center'/>
      </div>

      <div
         className='w-full h-full bg-[rgba(0,0,0,0.5)] flex flex-col justify-center px-[100px] absolute top-0 right-0'
      >
         <h1
            className={`text-4xl text-secondary font-bold relative font-medium before:absolute before:-bottom-1 
                     ...
                     before:transition hover:before:scale-100`}>
            {title}
         </h1>
