...
const ServicesSection = () => {
   ...
   return <div>
      ...
      <div className='bg-[url("/img/orangeBg.png")] w-full h-[200px] flex flex-col justify-center items-center text-white'>
