const FiveStars = () =>
    <div className="flex items-center">
        <svg aria-hidden="true" className="w-10 h-10 text-yellow" fill="currentColor" viewBox="0 0 20 20"
        ...
        <svg aria-hidden="true" className="w-10 h-10 text-yellow dark:text-gray-500" fill="currentColor"
